export type { Lang } from './content/common';
export { designVariants, heroCopy, metrics, navCopy, profile } from './content/common';
export { mediaMomentPosts, mediaPhotos, mediaWindowCopy, momentsAvatar, videoClips } from './content/media';
export { archives, experience, projects } from './content/portfolio';
